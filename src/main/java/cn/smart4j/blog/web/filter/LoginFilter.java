...
import cn.smart4j.blog.core.util.Threads;
import cn.smart4j.blog.service.shiro.StatelessToken;
import cn.smart4j.blog.service.vo.Global;
...
public class LoginFilter extends OncePerRequestFilter{
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    try{
      ...
      context.setUser(CookieRememberManager.extractValidRememberMeCookieUser(request, response));
      // 保存上下文
