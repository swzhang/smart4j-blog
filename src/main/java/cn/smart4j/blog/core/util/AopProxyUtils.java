...
public class AopProxyUtils {
    ...
    public static boolean isMultipleProxy(Object proxy) {
        try {
            ...
            TargetSource targetSource = (TargetSource) ReflectionUtils
                    .getField(ProxyFactory_targetSource_FIELD, proxyFactory);
      ...
      /* ignore */
        ...
        try {
            ...
            CglibAopProxy$DynamicAdvisedInterceptor_advised_FIELD = ReflectionUtils.findField(
                    CglibAopProxy$DynamicAdvisedInterceptor_CLASS, "advised");
