    ...
    <c:forEach items="${comments}" var="comment" varStatus="status">
        ...
        <div class="comment-meta">
            ...
            <ul class="comment-name-date">
                <li class="comment-name"><a class="url" target="_blank" href="${comment.url}">${comment.creator}</a>
                </li>
                <li class="comment-date"><fmt:formatDate value="${comment.createTime}"
                                                         pattern="yyyy/MM/dd hh:mma"/></li>
            </ul>
