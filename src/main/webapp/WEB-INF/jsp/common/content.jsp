...
<div class="post_wrap clearfix">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <div style="margin-top: 15px; font-style: italic;">
                        <p style="margin:0;"><strong>原创文章，转载请注明：</strong>转载自<a href="${g.domain}">${g.title} –
                            zhouhaocheng.com</a></p>
                    </div>
                </c:otherwise>
            </c:choose>
        </div>
    ...
    <div class="meta">
        <ul>
            ...
            <c:if test="${post.type=='post'}">
                <li class="post_category"><a
                        href="${g.domain}/categorys/${post.category.name}">${post.category.name}</a></li>
            </c:if>
