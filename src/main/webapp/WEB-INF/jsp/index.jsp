        ...
        <c:if test="${category!=null||tag!=null||archive!=null||search!=null}">
            <div id="archive_headline"><h2>
                <c:choose>
                    ...
                    <c:otherwise>归档之于 '<span><fmt:formatDate value="${archive}"
                                                             pattern="yyyy 年MMM"/></span>'</c:otherwise>
                </c:choose></h2>
            </div>
        </c:if>
                ...
                <div class="meta">
                    <ul>
                        ...
                        <li class="post_author">
                            <a rel="author" title="由${post.user.nickName}发布"
                               href="${g.domain}/authors/${post.creator}">${post.user.nickName}</a>
                        </li>
    ...
    <div id="right_col">
        <div id="introduction_widget" class="side_widget clearfix">
            ...
            <ul id="social_link">
                ...
                <li class="github_button"><a target="_blank" href="https://github.com/swzhang"></a></li>
            </ul>
