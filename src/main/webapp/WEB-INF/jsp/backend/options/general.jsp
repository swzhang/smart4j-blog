                ...
                <div class="panel-body">
                    ...
                    <form action="" method="post" class="form-horizontal text-left" role="form">
                        <div class="form-group ${title!=null?'has-error':''}">
                            ...
                            <div class="col-sm-6">
                                <input placeholder="站点标题" name="title" class="form-control" type="text"
                                       value="${form.title}"/>
                        ...
                        <div class="form-group ${subtitle!=null?'has-error':''}">
                            ...
                            <div class="col-sm-6">
                                <input placeholder="副标题" name="subtitle" class="form-control" type="text"
                                       value="${form.subtitle}"/>
                            </div>
                        </div>
                        <div class="form-group ${description!=null?'has-error':''}">
                            ...
                            <div class="col-sm-6">
                                <input placeholder="站点描述" name="description" class="form-control" type="text"
                        ...
                        <div class="form-group ${keywords!=null?'has-error':''}">
                            ...
                            <div class="col-sm-6">
                                <input placeholder="keywords" name="keywords" class="form-control" type="text"
                                       value="${form.keywords}"/>
                        ...
                        <div class="form-group ${webUrl!=null?'has-error':''}">
                            ...
                            <div class="col-sm-6">
                                <input placeholder="http://" name="webUrl" class="form-control" type="text"
                                       value="${form.webUrl}">
