                ...
                <div class="col-sm-9 col-md-9">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" id="title" class="form-control input-md" placeholder="输入标题"
                                   value="${post.title}"><br/>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="editor-txt">
                                    <textarea id="editor-txt-tt"
                                              style="width: 100%; height: 400px">${post.content}</textarea>
                                </div>
                                <div class="tab-pane" id="editor-ue">
                                    <!-- 必须要添加width:100% -->
                                    <script id="ueditor" style="width: 100%; height: 350px;"
                                            type="text/plain">${post.content}</script>
                                    </
                                    div >
                                    < / div >
                                    < / div >
                                    < div
                                    class
                                    = "panel-footer text-success" > 注
                                    :
                                    此三种编辑模式相互独立, 最终以当前选中标签页内容提交 < / div >
                                    < / div >
                                    < / div >
                                    < div
                                    class
                                    ...
                                    = "form-group" >
                                        < label
                                    for= "categoty" > 分类 < / label >
                                        < select class
                                    = "form-control"
                                    id = "category" >
                                        <c:forEach items="${categorys}" var="category" begin="1">
                                        < option
                                    value = "${category.id}" ${post.category.id==category.id?'selected':''} >
                                    ...
                                    = "form-group" >
                                        < label
                                    for= "pstatus" > 公开度 < / label > < br / >
                                        < label class
                                    = "radio-inline" >
                                        < input
                                    type = "radio"
                                    name = "pstatus"
                                    value = "publish" ${post.pstatus=='publish'?'checked':''} > 公开
                                        < / label >
                                        < label
                                    class
                                    = "radio-inline" >
                                    ...
                                    type = "radio"
                                    name = "pstatus"
                                    value = "secret" ${post.pstatus=='secret'?'checked':''} > 隐藏
                                        < / label >
                                        < / div >
                                        < div
                                    class
                                    ...
                                    = "form-control"
                                    id = "tags"
                                    value = "${z:join(post.tags,',')}" / >
                                        < span
                                    class
                                    = "help-block" > 多个标签请用英文逗号
                                    （,）
                                    分开 < / span >
                                    < / div >
                                    < div
                                    ...
                                    = "form-group" >
                                        < label
                                    for= "cstatus" > 是否允许评论 < / label > < br >
                                        < label class
                                    = "radio-inline" >
                                        < input
                                    type = "radio"
                                    name = "cstatus"
                                    value = "open" ${post.cstatus=='open'?'checked':''} > 是
                                        < / label >
                                        < label
                                    class
                                    = "radio-inline" >
                                    ...
                                    type = "radio"
                                    name = "cstatus"
                                    value = "close" ${post.cstatus=='close'?'checked':''} > 否
                                        < / label >
                                        < / div >
                                        < / div >
                                        < div
                                    ...
                                    onclick = "zblog.post.insert();" > 发布 < / button >
                                        < / div >
                                        < / div >
                                        < / div >
                                        < / div >
                                    ...
                                    src = "${g.domain}/resource/js/backend/admin.post.js" ></script>
</body>
</html>
