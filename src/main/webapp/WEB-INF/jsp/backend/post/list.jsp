                        ...
                        <tr id="edit-row">
                            <td colspan="6">
                                <div class="edit-col-left">
                                    ...
                                    <span><label>日期</label><input type="text" name="createTime"
                          ...
                          <input type="radio" name="pstatus" value="secret">隐藏</span>
                                ...
                                <div class="edit-col-center">
                                    ...
                                    <ul>
                                        <c:forEach items="${categorys}" var="category" begin="1">
                                            <li><input type="radio" name="category"
                           ...
                           <input type="radio" name="cstatus" value="close">否</span>
                                ...
                                <p>
                                    <button class="btn btn-default btn-sm" onclick="zblog.post.canclefast();">取消
                                    </button>
                                    <button style="float:right;" class="btn btn-primary btn-sm"
                                            onclick="zblog.post.submitfast();">更新
                                    </button>
                                </p>
                            </td>
                        </tr>
