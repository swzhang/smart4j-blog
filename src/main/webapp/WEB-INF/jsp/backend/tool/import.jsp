        ...
        <div class="col-sm-9 col-md-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="import" method="post" class="form-horizontal text-left" enctype="multipart/form-data"
                          role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="wordpress" name="wordpress" type="file" style="display:none"
                                       accept="text/xml" onchange="$('#up-helper').val($(this).val())"/>
